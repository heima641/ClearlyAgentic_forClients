...
def run_standard_analysis():
    ...
    return {"status": "success", "message": "Standard analysis workflow started"}, 200
...
def run_video_script():
    ...
    return {"status": "success", "message": "Video script workflow started"}, 200
...
def run_video_script_short():
    ...
    return {"status": "success", "message": "Short video script workflow started"}, 200
...
def run_threads_titles():
    ...
    return {"status": "success", "message": "Threads and titles workflow started"}, 200
...
def run_email_sequence():
    ...
    return {"status": "success", "message": "Email sequence workflow started"}, 200
...
def run_heygen_chunker():
    ...
    return {"status": "success", "message": "HeyGen 4-problem script chunker workflow started"}, 200

@app.route('/run_heygen_2prob_chunker', methods=['POST'])
def run_heygen_2prob_chunker():
    """Trigger HeyGen 2-problem script chunker workflow"""
    subprocess.Popen(["python", "heygen_2p_script_chunker_automation.py"])
    return {"status": "success", "message": "HeyGen 2-problem script chunker workflow started"}, 200
...
def run_heygen_4prob_video():
    ...
    return {"status": "success", "message": "HeyGen 4-problem video generator workflow started"}, 200
...
def run_heygen_2prob_video():
    ...
    return {"status": "success", "message": "HeyGen 2-problem video generator workflow started"}, 200
